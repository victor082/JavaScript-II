...
const largeShirtFilter = runners.filter(function(currentValue){
...
runners.forEach(function(shirtSizes){
    console.log(shirtSizes.shirt_size);
})
...
const donationsOver200 = runners.filter(function(currentValue){
